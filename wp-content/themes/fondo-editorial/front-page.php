                    ...
                    <div class="col-lg-8">
                        <div class="sb-slick-slider" data-slick-setting='{
                            ...
                            <div class="single-slide bg-image bg-position-left bg-position-lg-center"
                                data-bg="<?php echo esc_url(assets('image/bg-images/home-2-slider-1.jpg')); ?>">
                            ...
                            <div class="single-slide bg-image" data-bg="<?php echo esc_url(assets('image/bg-images/home-2-slider-2.jpg')); ?>">
                    ...
                    <div class="col-lg-4 mt--30 mt-lg--0">
                        <div class="sb-slick-slider hero-products-group-slider product-border-reset" data-slick-setting='{
                            ...
                            <div class="single-slide">
                                <div class="product-card card-style-list">
                                    <div class="card-image">
                                        <img src="<?php echo esc_url(assets('image/products/product-1.jpg')); ?>" alt="">
                                    </div>
                                    <div class="product-card--body">
                                        ...
                                        <div class="price-block">
                                            <span class="price">S/51.20</span>
                                            <del class="price-old">S/51.20</del>
                            ...
                            <div class="single-slide">
                                <div class="product-card card-style-list">
                                    <div class="card-image">
                                        <img src="<?php echo esc_url(assets('image/products/product-2.jpg')); ?>" alt="">
                                    </div>
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            <a href="" class="author">
                            ...
                            <div class="single-slide">
                                <div class="product-card card-style-list">
                                    <div class="card-image">
                                        <img src="<?php echo esc_url(assets('image/products/product-3.jpg')); ?>" alt="">
                                    </div>
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            <a href="" class="author">
                            ...
                            <div class="single-slide">
                                <div class="product-card card-style-list">
                                    <div class="card-image">
                                        <img src="<?php echo esc_url(assets('image/products/product-4.jpg')); ?>" alt="">
                                    </div>
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            <a href="" class="author">
                            ...
                            <div class="single-slide">
                                <div class="product-card card-style-list">
                                    <div class="card-image">
                                        <img src="<?php echo esc_url(assets('image/products/product-5.jpg')); ?>" alt="">
                                    </div>
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            <a href="" class="author">
                            ...
                            <div class="single-slide">
                                <div class="product-card card-style-list">
                                    <div class="card-image">
                                        <img src="<?php echo esc_url(assets('image/products/product-7.jpg')); ?>" alt="">
                                    </div>
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            <a href="" class="author">
                ...
                <div class="row space-db--30">
                    <div class="col-lg-6 mb--30">
                        <a href="" class="promo-image promo-overlay">
                            <img src="<?php echo esc_url(assets('image/bg-images/promo-banner-with-text.jpg')); ?>" alt="">
                        </a>
                    </div>
                    <div class="col-lg-6 mb--30">
                        <a href="" class="promo-image promo-overlay">
                            <img src="<?php echo esc_url(assets('image/bg-images/promo-banner-with-text-2.jpg')); ?>" alt="">
                        </a>
                    </div>
                </div>
            </div>
                            ...
                            {"breakpoint":320, "settings": {"slidesToShow": 1} }
                                ...
                                <div class="single-slide">
                                    <div class="product-card">
                                        ...
                                        <div class="product-card--body">
                                            <div class="card-image">
                                                <img src="<?php echo esc_url(assets('image/products/product-6.jpg')); ?>" alt="">
                                                <div class="hover-contents">
                                                    <a href="product-details.html" class="hover-image">
                                                        <img src="<?php echo esc_url(assets('image/products/product-7.jpg')); ?>" alt="">
                                                    </a>
                                ...
                                <div class="single-slide">
                                    <div class="product-card">
                                        ...
                                        <div class="product-card--body">
                                            <div class="card-image">
                                                <img src="<?php echo esc_url(assets('image/products/product-8.jpg')); ?>" alt="">
                                                <div class="hover-contents">
                                                    <a href="product-details.html" class="hover-image">
                                                        <img src="<?php echo esc_url(assets('image/products/product-9.jpg')); ?>" alt="">
                                                    </a>
                                                    <div class="hover-btns">
                                                        <a href="cart.html" class="single-btn">
                                                            <i class="fas fa-shopping-basket"></i>
                                ...
                                <div class="single-slide">
                                    <div class="product-card">
                                        ...
                                        <div class="product-card--body">
                                            <div class="card-image">
                                                <img src="<?php echo esc_url(assets('image/products/product-10.jpg')); ?>" alt="">
                                                <div class="hover-contents">
                                                    <a href="product-details.html" class="hover-image">
                                                        <img src="<?php echo esc_url(assets('image/products/product-11.jpg')); ?>" alt="">
                                                    </a>
                                                    <div class="hover-btns">
                                                        <a href="cart.html" class="single-btn">
                                                            <i class="fas fa-shopping-basket"></i>
                                ...
                                <div class="single-slide">
                                    <div class="product-card">
                                        ...
                                        <div class="product-card--body">
                                            <div class="card-image">
                                                <img src="<?php echo esc_url(assets('image/products/product-12.jpg')); ?>" alt="">
                                                <div class="hover-contents">
                                                    <a href="product-details.html" class="hover-image">
                                                        <img src="<?php echo esc_url(assets('image/products/product-11.jpg')); ?>" alt="">
                                                    </a>
                ...
                <div class="row">
                    <div class="col-lg-4 mb--30 mb-lg--0">
                        <div class="home-left-sidebar">
                                ...
                                <div class="product-slider countdown-single with-countdown sb-slick-slider"
                                    ...
                                    <div class="single-slide">
                                        <div class="product-card">
                                            ...
                                            <div class="product-card--body">
                                                <div class="card-image">
                                                    <img src="<?php echo esc_url(assets('image/products/product-13.jpg')); ?>" alt="">
                                                    <div class="hover-contents">
                                                        <a href="product-details.html" class="hover-image">
                                                            <img src="<?php echo esc_url(assets('image/products/product-11.jpg')); ?>" alt="">
                                                        </a>
                            ...
                            <div class="single-side">
                                <a href="#" class="promo-image promo-overlay">
                                    <img src="<?php echo esc_url(assets('image/bg-images/promo-banner-small-with-text.jpg')); ?>" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="home-right-block">
                            ...
                            <div class="single-block bg-white">
                                <div class="section-title mt-0">
                                    <h2>LIBROS DE ARTE Y FOTOGRAFÍA</h2>
                                </div>
            ...
            <div class="container">
                <div class="promo-wrapper promo-type-four">
                    <a href="#" class="promo-image promo-overlay bg-image"
                        data-bg="<?php echo esc_url(assets('image/bg-images/promo-banner-contained.jpg')); ?>">
                        <!-- <img src="<?php echo esc_url(assets('image/bg-images/promo-banner-contained.jpg')); ?>" alt="" class="w-100 h-100"> -->
                    </a>
            ...
            <div class="container">
                ...
                {"breakpoint":1200, "settings": {"slidesToShow": 1} }
                    ...
                    <div class="single-slide">
                        <div class="blog-card">
                            <div class="image">
                                <img src="<?php echo esc_url(assets('image/others/blog-grid-1.jpg')); ?>" alt="">
                            </div>
                            <div class="content">
                    ...
                    <div class="single-slide">
                        <div class="blog-card">
                            <div class="image">
                                <img src="<?php echo esc_url(assets('image/others/blog-grid-2.jpg')); ?>" alt="">
                            </div>
                            <div class="content">
                                <div class="content-header">
                                    <div class="date-badge">
                    ...
                    <div class="single-slide">
                        <div class="blog-card">
                            <div class="image">
                                <img src="<?php echo esc_url(assets('image/others/blog-grid-3.jpg')); ?>" alt="">
                            </div>
                            <div class="content">
                                <div class="content-header">
                                    <div class="date-badge">
                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                ...
                                <div class="product-details-slider sb-slick-slider arrow-type-two" data-slick-setting='{
                                    ...
                                    <div class="single-slide">
                                        <img src="<?php echo esc_url(assets('image/products/product-details-1.jpg')); ?>" alt="">
                                    </div>
                                    <div class="single-slide">
                                        <img src="<?php echo esc_url(assets('image/products/product-details-2.jpg')); ?>" alt="">
                                    </div>
                                    <div class="single-slide">
                                        <img src="<?php echo esc_url(assets('image/products/product-details-3.jpg')); ?>" alt="">
                                    </div>
                                    <div class="single-slide">
                                        <img src="<?php echo esc_url(assets('image/products/product-details-4.jpg')); ?>" alt="">
                                    </div>
                                    <div class="single-slide">
                                        <img src="<?php echo esc_url(assets('image/products/product-details-5.jpg')); ?>" alt="">
                                    </div>
                                </div>
              ...
              "focusOnSelect": true
                            ...
                            <div class="col-lg-7 mt--30 mt-lg--30">
                                <div class="product-details-info pl-lg--30 ">
                                    <p class="tag-block">Etiquetas: <a href="#">Movado</a>, <a href="#">Omega</a></p>
                                    <h3 class="product-title">Auriculares con cable Beats EP On-Ear-Negro</h3>
                                    <ul class="list-unstyled">
                                        <li>Ex Tax: <span class="list-value"> S/60.24</span></li>
                                        <li>Brands: <a href="#" class="list-value font-weight-bold"> Canon</a></li>
                                        <li>Cód. de Producto: <span class="list-value"> model1</span></li>
                                        <li>Puntos de Recompensa: <span class="list-value"> 200</span></li>
                                        <li>Disponibilidad: <span class="list-value"> En Stock</span></li>
                                    </ul>
                                    <div class="price-block">
                                        <span class="price-new">S/73.79</span>
                                        <del class="price-old">S/91.86</del>
                                    </div>
                    ...
                    <div class="modal-footer">
                        <div class="widget-social-share">
                            <span class="widget-label">Compartir:</span>
        ...
        <section class="section-margin">
            ...
            <div class="container">
                <div class="brand-slider sb-slick-slider border-top border-bottom" data-slick-setting='{
                    ...
                    <div class="single-slide">
                        <img src="<?php echo esc_url(assets('image/others/brand-1.jpg')); ?>" alt="">
                    </div>
                    <div class="single-slide">
                        <img src="<?php echo esc_url(assets('image/others/brand-2.jpg')); ?>" alt="">
                    </div>
                    <div class="single-slide">
                        <img src="<?php echo esc_url(assets('image/others/brand-3.jpg')); ?>" alt="">
                    </div>
                    <div class="single-slide">
                        <img src="<?php echo esc_url(assets('image/others/brand-4.jpg')); ?>" alt="">
                    </div>
                    <div class="single-slide">
                        <img src="<?php echo esc_url(assets('image/others/brand-5.jpg')); ?>" alt="">
                    </div>
                    <div class="single-slide">
                        <img src="<?php echo esc_url(assets('image/others/brand-6.jpg')); ?>" alt="">
                    </div>
                    <div class="single-slide">
                        <img src="<?php echo esc_url(assets('image/others/brand-1.jpg')); ?>" alt="">
                    </div>
